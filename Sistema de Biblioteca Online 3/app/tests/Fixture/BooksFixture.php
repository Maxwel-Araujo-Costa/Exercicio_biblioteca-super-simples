...
class BooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'publisher' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'year' => 1,
                'created' => '2020-02-14 19:29:30',
                'modified' => '2020-02-14 19:29:30',
            ],
        ];
        parent::init();
    }
